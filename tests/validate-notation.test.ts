...
const GROUP_D = ['driver', 'actor', 'change', 'stakeholder', 'target-state', 'location', 'node'];
...
describe('validate-notation — element notation corpus validates clean (#518 C1)', () => {
  for (const notation of ['requirement', 'assertion', 'verification', 'risk', 'metric', 'need', 'validation', 'driver', 'actor', 'change', 'stakeholder', 'target-state', 'location', 'node'] as const) {
