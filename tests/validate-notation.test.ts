...
const GROUP_D = ['driver', 'actor', 'change', 'stakeholder', 'location'];
...
describe('validate-notation — element notation corpus validates clean (#518 C1)', () => {
  for (const notation of ['requirement', 'assertion', 'verification', 'risk', 'metric', 'need', 'validation', 'driver', 'actor', 'change', 'stakeholder', 'location'] as const) {
