...
[`dependencies.md`](dependencies.md). Third-party scan (transitrix-hq#135) is **partial** —
one engine's clean verdicts recorded, a second is blocked on a credential/dependency decision
